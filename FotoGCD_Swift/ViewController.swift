...
//  FotoGCD_Swift
//
//  Created by Dmitry on 27/04/2019.
...
class ViewController: UITableViewController {
    ...
    let urlsOfStr = [
        "https://www.google.com/url?sa=i&rct=j&q=&esrc=s&source=images&cd=&cad=rja&uact=8&ved=2ahUKEwi60O3Rs-_hAhWNwsQBHSa3CoEQjRx6BAgBEAU&url=https%3A%2F%2Fbipbap.ru%2Fkrasivye-kartinki%2Fkrasivye-kartinki-kosmosa-36-foto.html&psig=AOvVaw2tmhczGGMK0C4qJ-Cg-Kz8&ust=1556424608184796",
    ...
    override func tableView(_ tableView: UITableView, willDisplay cell: UITableViewCell, forRowAt indexPath: IndexPath) {
        ...
        let imagesLoadQueue = DispatchQueue(label: "ImagesLoadQueue", qos: .userInteractive, attributes: .concurrent)
        
        imagesLoadQueue.async {
            ImageService.downloadImage(by: url) { image in cell.setImage(image) }
        }
    }
}
...
class TableCell: UITableViewCell {
    ...
    @IBOutlet private var fotoView: UIImageView!
